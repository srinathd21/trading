...
<head>
    ...
    <style>
        * {
        ...
        /* Paint manual sale mode */
        .paint-sale-section {
            display: grid !important;
            grid-template-columns: 2fr 0.7fr 1.1fr 0.9fr 0.55fr;
            gap: 10px;
            align-items: end;
            background: #fffef8;
        ...
        .paint-sale-section .paint-manual-field label {
            margin-bottom: 4px;
        }
        .paint-sale-section input,
        .paint-sale-section select {
            height: 34px;
            font-size: 13px;
        }
        .paint-sale-section #qty input {
            width: 100%;
        }
        .paint-sale-section #qty span {
            height: 34px;
            padding: 8px 7px 0;
        }
        .paint-add-wrap {
...
<body>
<div class="manual-sale-note-final" style="background:#fff7ed;border:1px solid #fed7aa;color:#9a3412;padding:7px 12px;margin:4px;border-radius:4px;font-weight:600;">
    Manual Seller Sale: product is entered by seller, not from products table. No stock check and no stock deduction.
</div>
    <!-- Toast Container -->
    ...
    <input type="datetime-local" id="date" name="date" class="p-1">
        ...
        <div class="center-section">
            <h6>Add Manual Paint Product</h6>
            <div class="gst-filter-section" style="display:none !important;">
    ...
    <div class="d-flex align-items-center gap-3">
        ...
        <div class="ms-auto d-flex align-items-center gap-2">
            ...
            <div class="product-select-section paint-sale-section">
                
                <div class="paint-manual-field paint-product-name-wrap">
                    <label for="manual-product-name">Product Name / Paint Description</label>
                    <input type="text" id="manual-product-name" name="manual-product-name"
                           placeholder="Enter paint/product name manually">
                </div>

                <div class="paint-manual-field">
                    <label for="qty-input">Quantity</label>
                    <div id="qty">
                        <input type="number" id="qty-input" name="qty" min="0.001" step="0.001" value="1">
                        <span id="qty-unit">pcs</span>
                    </div>
                </div>

                <div class="paint-manual-field">
                    <label for="manual-hsn-select">HSN / GST</label>
                    <select id="manual-hsn-select" name="manual-hsn-select">
                ...
                <div class="paint-manual-field">
                    ...
                    <input type="number" id="selling-price" name="selling-price" value="0" min="0" step="0.01"
                           placeholder="Enter selling price">
                </div>

                <div class="product-add-button paint-add-wrap">
                    <button id="product-add-button" type="button">
                        <i class="fas fa-plus me-1"></i> Add
                    </button>
                </div>

                <!-- Hidden legacy controls kept for existing POS script compatibility -->
                <div style="display:none !important;">
                    ...
                    <div id="barcode">
                        <input type="text" id="barcode-input" name="barcode" placeholder="Scan barcode" disabled>
                    </div>
                    <button id="unit-convert" type="button" disabled><i class="fas fa-exchange-alt me-1"></i></button>
    ...
    <div class="fixed-bottom-buttons">
        <button id="btnAutoFillRemaining" class="btn btn-outline-primary d-none">
            <i class="fas fa-magic me-1"></i> Auto-fill
        </button>
        <button id="btnGenerateBill" class="btn btn-primary d-none">
    ...
    <?php include('pos/paint_script.php'); ?>
</body>
